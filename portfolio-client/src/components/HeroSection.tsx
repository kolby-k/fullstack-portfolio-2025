...
function HeroSection() {
  ...
  return (
    <div className="flex flex-col items-center justify-evenly lg:flex-row gap-x-8">
      <span className="flex flex-col justify-between gap-2 mb-8">
        ...
        <span className="w-1/2 max-w-92 mb-2 mt-4 md:mt-8 mx-auto nav-glow rounded-sm">
          <CustomButton
            label="Get in touch"
